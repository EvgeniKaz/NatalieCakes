...
public class UserApi {
	...
	@GetMapping
	public void getUser(@RequestParam("token") int token,HttpServletRequest request) throws ApplicationException, ParseException{
		UserDataCashe userDataCache = (UserDataCashe) request.getAttribute("userData");
		userController.getUserById(userDataCache,userDataCache.getUserID());
	}
	@PutMapping
