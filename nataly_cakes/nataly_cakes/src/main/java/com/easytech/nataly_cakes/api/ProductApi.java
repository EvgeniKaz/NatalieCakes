...
public class ProductApi {
	...
	public void getProductById(@PathVariable("productId") long id) throws ApplicationException, ParseException {
		productController.getProductById(id);
	}
	@GetMapping 
	public void getAllProducts() throws ApplicationException, ParseException {
